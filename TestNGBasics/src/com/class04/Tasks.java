...
//
//
//Note: Create BeforeMethod and AfterMethod annotations to open browser and
//logout from the application. Create a xml file with parameters username and password .